...
@objc public class DateTimePicker: UIView {
    ...
    // Include timer picker
    public var includeTimer = false {
        didSet {
            if includeTimer {
    ...
    // Timer view
    internal var timerView: UIDatePicker!
    ...
    private func configureView() {
        ...
        contentHeight = includeTimer ? 330 : isDatePickerOnly ? 228 : isTimePickerOnly ? 230 : 330
        if let window = UIApplication.shared.keyWindow {
        ...
        // Timer view
        timerView = UIDatePicker(frame: CGRect.zero)
        timerView.datePickerMode = UIDatePicker.Mode.countDownTimer
        contentView.addSubview(timerView)
        
        timerView.translatesAutoresizingMaskIntoConstraints = false
        timerView.topAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -10 - 160 - 10).isActive = true
        timerView.heightAnchor.constraint(equalToConstant: 100).isActive = true
        timerView.leadingAnchor.constraint(equalTo: contentView.layoutMarginsGuide.leadingAnchor, constant: 0).isActive = true
        timerView.trailingAnchor.constraint(equalTo: contentView.layoutMarginsGuide.trailingAnchor, constant: 0).isActive = true
        timerView.setValue(UIColor(red: 41.0/255.0, green: 122.0/255.0, blue: 230.0/255.0, alpha: 1), forKey: "textColor")
